...
class CustomSegmentedButton<T extends Object> extends StatelessWidget {
  ...
  final ButtonStyle? style; // Optional: allow custom styling per instance if needed
  ...
  Widget build(BuildContext context) {
    ...
    final defaultStyle = SegmentedButton.styleFrom(
      ...
      textStyle: const TextStyle(fontSize: 12, fontFamily: "Montserrat", fontWeight: FontWeight.w500),
      ...
      visualDensity: VisualDensity.compact, // Use compact density for a tighter fit
